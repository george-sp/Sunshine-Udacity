...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
     ...
     * @param lng the longitude of the city
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lng) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            locationValues.put(WeatherContract.LocationEntry.COLUMN_COORD_LNG, lng);
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            /**
             *  The next lines display what what you stored in the bulkInsert
             */
